...
print(page_number)
with open('testing.html', 'w', encoding='utf-8') as file:
        file.write(data)
# Note: json_data will not be serialized by requests
# exactly as it was in the original request.
#response = requests.post('https://www.booking.com/dml/graphql', params=params, cookies=cookies, headers=headers, data=data)